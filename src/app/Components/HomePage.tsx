    ...
    <>
      <div className={styles.sidebar}>
        ...
        >
          ...
          />
          <div className="socialMedia" style={{width:"100%",height:"4vh",backgroundColor:"red",marginBottom:"2vh"}}>
        ...
        <a href="#Resume"><DescriptionOutlinedIcon style={{marginRight:"1vh"}}/>Resume</a>
        <a href="#Projects"> <TaskOutlinedIcon style={{marginRight:"1vh"}}/>Projects</a>
